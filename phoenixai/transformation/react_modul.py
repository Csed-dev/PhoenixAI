class ReActAgent:
    ...
    def think(self, current_context):
        ...
        """
        raise NotImplementedError("Die Methode 'think' muss in einer Unterklasse implementiert werden.")
    ...
    def act(self, thought):
        ...
        """
        raise NotImplementedError("Die Methode 'act' muss in einer Unterklasse implementiert werden.")
    ...
    def observe(self, action_result):
        ...
        """
        raise NotImplementedError("Die Methode 'observe' muss in einer Unterklasse implementiert werden.")
